...
# 2 "<built-in>" 2
# 1 "../src/boards/z8s57q.c" 2
# 26 "../src/boards/z8s57q.c"
...
# 287 "../src/boards/../supermez80.h" 2
# 26 "../src/boards/z8s57q.c" 2
...
# 28 "../src/boards/z8s57q.c" 2

# 1 "../src/boards/../../drivers/mcp23s08.h" 1
# 29 "../src/boards/../../drivers/mcp23s08.h"
struct MCP23S08;
...
# 29 "../src/boards/z8s57q.c" 2

# 1 "../src/boards/../../drivers/picregister.h" 1
# 30 "../src/boards/z8s57q.c" 2
...
# 34 "../src/boards/z8s57q.c" 2
# 66 "../src/boards/z8s57q.c"
...
static void emuz80_common_start_z80(void)
{
    ...
    WPUC5 = 1;
    TRISC5 = 1;
# 155 "../src/boards/emuz80_common.c"
    LATA4 = 1;
    TRISA4 = 0;
...
static uint8_t emuz80_common_addr_l_pins(void) { return PORTB; }
static void emuz80_common_set_addr_l_pins(uint8_t v) { LATB = v; }
static uint8_t emuz80_common_data_pins(void) { return PORTF; }
static void emuz80_common_set_data_pins(uint8_t v) { LATF = v; }
static void emuz80_common_set_data_dir(uint8_t v) { TRISF = v; }
static __bit emuz80_common_ioreq_pin(void) { return RA0; }
static __bit emuz80_common_memrq_pin(void) { return RA1; }
static __bit emuz80_common_rd_pin(void) { return RA5; }
static void emuz80_common_set_busrq_pin(uint8_t v) { LATE0 = (__bit)(v & 0x01); }
static void emuz80_common_set_reset_pin(uint8_t v) { LATE1 = (__bit)(v & 0x01); }
...
static void emuz80_57q_sys_init()
{
    ...
    (*board_set_bank_pins_hook)(0x00000);
...
# 32 "../src/boards/../../drivers/pic18f47q43_spi.c"
struct SPI_HW {
    struct SPI spi;
...
# 27 "../src/boards/../../drivers/SDCard.c" 2
