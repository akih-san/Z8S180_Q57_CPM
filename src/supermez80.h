...
#endif
#define UART_DREG 0x41          // 40h Data REG
#define UART_CREG 0x40          // 41h Control REG
#define DISK_REG_DATA    0x48   // 48h fdc-port: data (non-DMA)
#define DISK_REG_DRIVE   0x4a   // 4Ah fdc-port: # of drive
#define DISK_REG_TRACK   0x4b   // 4Bh fdc-port: # of track
#define DISK_REG_SECTOR  0x4c   // 4Ch fdc-port: # of sector
#define DISK_REG_FDCOP   0x4d   // 4Dh fdc-port: command
#define DISK_REG_FDCST   0x4e   // 4Eh fdc-port: status
#define DISK_REG_DMAL    0x4f   // 4Fh dma-port: dma address low
#define DISK_REG_DMAH    0x50   // 50h dma-port: dma address high
#define DISK_REG_SECTORH 0x51   // 51h fdc-port: # of sector high
#define MMU_INIT         0x54   // 54h MMU initialisation
#define MMU_BANK_SEL     0x55   // 55h MMU bank select
#define MMU_SEG_SIZE     0x56   // 56h MMU select segment size (in pages a 256 bytes)
#define MMU_WR_PROT      0x57   // 57h MMU write protect/unprotect common memory segment
